...
class TestServiceContainer:
    ...
    def test_reset_clears_services(self):
        ...
        with (
            patch("src.ingestion.indexing.factory.ChromaVectorStoreFactory") as mock_factory,
    ...
    def test_get_vector_store_with_config(self):
        ...
        with patch("src.ingestion.indexing.factory.ChromaVectorStoreFactory") as mock_factory:
