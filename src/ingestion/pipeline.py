...
Usage:
    python -m src.ingestion.pipeline           # Run full pipeline
    python -m src.ingestion.pipeline --force   # Force rebuild of vector store
    python -m src.ingestion.pipeline --skip-download  # Skip L0 download
"""
